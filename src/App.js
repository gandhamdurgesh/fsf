...
import { Navbar, Container, Nav, Carousel, Card, Button, Collapse,  Row, Col  } from 'react-bootstrap';
  ...
  return (
    ...
    <div className="App">
      <Navbar variant="dark" expand="lg" fixed="top" className={scrolled ? 'navbar-scrolled' : ''}>
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ml-auto"> {/* ml-auto aligns items to the right */}
              <Nav.Link href="/home" className="nav-link">Home</Nav.Link>
              <Nav.Link href="#industries" className="nav-link">Industries</Nav.Link>
              <Nav.Link href="#services" className="nav-link">Services</Nav.Link>
              <Nav.Link href="#Teams" className="nav-link">Team</Nav.Link>
      ...
      <Carousel.Item>
        <img
          className="d-block w-100"
          src="https://thumbs.dreamstime.com/b/data-protection-cyber-security-privacy-business-internet-technology-concept-153621251.jpg"
          alt="First slide"
        />
        <Carousel.Caption>
          <div className="carousel-caption">
      ...
      <Carousel.Item>
        <img
          className="d-block w-100"
          src="https://static.vecteezy.com/system/resources/thumbnails/023/127/752/small_2x/hand-using-laptop-to-play-social-media-a-mobile-phone-with-a-notification-people-icon-social-distancing-working-from-home-concept-international-consulting-company-social-networking-hologram-icons-photo.jpg"
          alt="Second slide"
        />
        <Carousel.Caption>
          <div className="carousel-caption">
      ...
      <Carousel.Item>
        <img
          className="d-block w-100"
          src="https://static.vecteezy.com/system/resources/thumbnails/001/759/015/small/gold-and-silver-chess-pieces-free-photo.jpg"
          alt="Third slide"
        />
        <Carousel.Caption>
          <div className="carousel-caption">
...
<div id="Teams"className="row mb-4">
    <div className="col-8 text-center">
     ...
     <p className="col-12 text-center" style={{ fontSize: 'calc(0.9rem + 0.5vw)', marginTop: '60px',marginLeft: '30px' }}>
...
<Container className="clients-logos" id="client" style={{ marginTop: '110px'}}>
      <h2 style={{ marginBottom: '70px'}}>Our Clients & Partners</h2>
      <p style={{ marginBottom: '50px', fontSize: '20px'}}>Forever, We thrive to maintain Successful Relationships with our Clients and Partners to showcase a healthy relationship and improving opportunities.</p>
      <Row>
      ...
      <Container>
        <Row>
          <Col lg={3} md={6} sm={12} className="mb-4">
            <h5 style={{ color: '#fff', fontSize: '25px' }}>Navigation</h5>
            <ul className="list-unstyled">
              <li><a href="" style={{ color: 'deepskyblue', textDecoration: 'none', fontSize: '18px' }}>Home</a></li>
              <li><a href="#Teams" style={{ color: 'deepskyblue', textDecoration: 'none', fontSize: '18px' }}>Team</a></li>
              <li><a href="#services" style={{ color: 'deepskyblue', textDecoration: 'none' , fontSize: '18px'}}>Services</a></li>
              <li><a href="#contact" style={{ color: 'deepskyblue', textDecoration: 'none' , fontSize: '18px'}}>Contact</a></li>
            </ul>
          </Col>
          <Col lg={3} md={6} sm={12} className="mb-4">
            <h5 style={{ color: '#fff', fontSize: '25px' }}>Social Media</h5>
            <ul className="list-unstyled">
              <li><a href="https://twitter.com" target="_blank" rel="noopener noreferrer"><i className="fab fa-twitter" style={{ color: '#fff', fontSize: '24px',marginTop: '10px'  }} /></a></li>
              <li><a href="https://facebook.com" target="_blank" rel="noopener noreferrer"><i className="fab fa-facebook" style={{ color: '#fff', fontSize: '24px' ,marginTop: '10px' }} /></a></li>
              <li><a href="https://instagram.com" target="_blank" rel="noopener noreferrer"><i className="fab fa-instagram" style={{ color: '#fff', fontSize: '24px',marginTop: '10px'  }} /></a></li>
              <li><a href="https://youtube.com" target="_blank" rel="noopener noreferrer"><i className="fab fa-youtube" style={{ color: '#fff', fontSize: '24px',marginTop: '10px'  }} /></a></li>
            </ul>
          </Col>
          <Col lg={3} md={6} sm={12} className="mb-4">
            <h5 style={{ color: '#fff' , fontSize: '18px'}}>Newsletter</h5>
            <p style={{  color: 'deepskyblue', fontSize: '18px' }}>Stay updated with our latest news and updates!</p>
            
           
          </Col>
          <Col lg={3} md={6} sm={12} className="mb-4">
            <h5 style={{ color: '#fff' , fontSize: '25px'}}>Legal</h5>
            <ul className="list-unstyled">
              <li><a href="#" style={{ color: 'deepskyblue', textDecoration: 'none' , fontSize: '18px'}}>Privacy Policy</a></li>
              <li><a href="#" style={{  color: 'deepskyblue', textDecoration: 'none' , fontSize: '18px'}}>Terms & Conditions</a></li>
            </ul>
          </Col>
        </Row>
        <Row>
